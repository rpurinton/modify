...
class ProcessManager
{
	...
	{
		$pids = $this->getPids();
		if (sizeof($pids) === 2) echo ("modify is running... (pids " . implode(" ", $pids) . ")\n");
		elseif (sizeof($pids)) echo ("WARNING; modify is HALF running... (pids " . implode(" ", $pids) . ")\n");
		else echo ("modify is stopped.\n");
	}

	private function start()
	{
		$pids = $this->getPids();
		if (sizeof($pids)) die("ERROR: modify is already running.  Not starting.\n");
